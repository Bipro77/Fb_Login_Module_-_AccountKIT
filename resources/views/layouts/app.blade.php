...
<div class="fb-login-button" data-max-rows="1" data-size="large" data-button-type="continue_with" data-show-faces="false" data-auto-logout-link="false" data-use-continue-as="true" onclick="javascript:login();"></div>
    <!-- JavaScripts -->
...
<div id="fb-root"></div>
        ...
        //
        //Javascript
var uri = encodeURI('http://maya.com');
